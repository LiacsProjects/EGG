"""Exp5 Age-based stagger adults v5: based on v1 with higher temperature
Adults: temp=0.4, lr=0.001 | Children: temp=3.5, lr=0.006
Only temp_max increased from v1 (1.6 -> 3.5), LR unchanged.
All agents start at age 100 (full adults).
"""
...
def grid():
    base = [
        ...
        "--checkpoint_dir=experiments/exp5/age_based_stagger_adults_v5",
        "--n_epochs=400",
