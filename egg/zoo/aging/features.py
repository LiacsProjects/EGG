...
class VectorsLoader:
    ...
    def get_iterators(self, is_distributed=False):
        if self.load_data_path:
            ...
            ), "Not enough data for requested split sizes"
        ...
        if is_distributed:
            train_sampler = data.distributed.DistributedSampler(
                train_dataset, shuffle=self.shuffle_train_data, drop_last=True, seed=self.seed
            )
        ...
        train_it = data.DataLoader(
            ...
            drop_last=True,
            shuffle=(train_sampler is None) and self.shuffle_train_data,
